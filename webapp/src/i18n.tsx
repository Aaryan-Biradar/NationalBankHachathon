...
const messages = {
  en: {
    ...
    'analysis.qualityErrors': 'Errors',
    'analysis.qualityWarnings': 'Warnings',
    'analysis.qualityInfo': 'Info',
  ...
  fr: {
    ...
    'analysis.dataQuality': 'Qualite des donnees',
    'analysis.qualityErrors': 'Erreurs',
    'analysis.qualityWarnings': 'Avertissements',
    'analysis.qualityInfo': 'Info',
